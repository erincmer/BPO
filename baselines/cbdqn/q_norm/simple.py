...
from baselines.cbdqn.q_norm.replay_buffer import ReplayBuffer, PrioritizedReplayBuffer
from baselines.cbdqn.q_norm.utils import BatchInput, load_state, save_state
...
class ActWrapper(object):
    ...
    def load(path):
        ...
        act = q_norm.build_act(**act_params)
        sess = tf.Session()
        sess.__enter__()
...
def learn(env,
    ...
    act, train, update_target, debug, val = q_norm.build_train(
