...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        tot_val = (q_tp1_best * bin_val  + bin_val/2) + min_Val # bin2Q -> max_{a'}(Q(\phi_{j+1), a')
        ...
        val = U.function( # this is added only to monitor if values are calculated correctly
            ...
            outputs=[new_errors,q_t,q_tp1, q_t_selected , q_t_selected_target , q_tp1_best ,tot_val,q_t_val  ]
        )
